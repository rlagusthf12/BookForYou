	...
	<div class="wrap">
        ...
        <div class="content">
            ...
            <form id="updateForm" action="" method="post"> 
	        	...
	        	<input type="hidden" id="writer" name="memNo" value="${ b.memNo }">
                <!--카테고리-->
                ...
                <div class="title_area">
                    <div class="title" id="title">
                        <input type="text" class="title_input" name="boTitle" value="${ b.boTitle }">
                    </div>
                </div>
                <!--에디터-->
	...
	<script>
		function btnSubmit(num) {
	        if (num == 1) { // 취소
	            ...
	            $("#updateForm").attr("action", "update.bo").submit();
	        }
	    }
		// *summernote 에디터
			...
			function uploadSummernoteImage(file, el){
				...
				$.ajax({
					...
					success: function(imageUrl){
						$('#boContent').summernote("insertImage", imageUrl.url);
