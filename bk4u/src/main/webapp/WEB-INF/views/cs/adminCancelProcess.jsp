...
<body>
	...
	<div id="outer">
            ...
            <table class="table table-hover table-sm">
                ...
                <tbody>
                    <tr>
                        <td>기타</td>
                        <td>
                            <textarea name="" id="" class="textarea" style="resize: none;">${ c.cancelReason }</textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <form action="adminProcess.cs" method="POST">
        	<input type="hidden" name="kindNo" value="${ c.cancelNo }">
        	<input type="hidden" name="orderNo" value="${ o.orderNo }">
        	<input type="hidden" name="refundKind" value="취소">
        	<div>
	            <div class="caption">
	                <p>-- 환불방식 --</p>
	            </div>
	        ...
	        <br><br>
	        <div id="btn-area">
	            <button type="button">취소 철회</button>
	            <button type="submit" id="cancel-btn">취소 처리</button>
