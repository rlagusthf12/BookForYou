	...
	<div id="outer">
        ...
        <div id="processing-area">
            ...
            <div>
                <div class="processing-box">
                    <div class="img-area">
                        <img class="img-content" src="../resources/return.png" alt="">
                    </div>
            ...
            <div>
                <div class="processing-box selected">
                    <div class="img-area selected">
                        <img class="img-content" src="../resources/refund selected.png" alt="">
                    </div>
        ...
        <div class="bar-outer" id="search-area">
            <form action="">
                <div id="search-bar">
                    <div id="search-condition">
                        <select name="condition">
                            ...
                            <option value="bookName">배송번호</option>
                ...
                <div class="form-check form-check-inline">
                    <span>취소상태</span>
                    <input type="radio"> 전체
                    <input type="radio"> 환불전
                    <input type="radio"> 환불완료
                </div>
                <br>
                <div id="search-btn">
        ...
        <div id="result-area">
            ...
            <div id="array-div">
                <select name="" id="array-condition">
                    <option value="">환불신청일순</option>
                    <option value="">환불신청일 역순 </option>
                </select>
            </div>
