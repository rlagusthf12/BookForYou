                ...
                <div id="search-bar">
                    <div id="search-condition">
                        <select name="condition" >
                            ...
                            <option value="refundNo">환불번호</option>
        ...
        <div id="result-area">
            ...
            <div id="array-div">
                <select name="" id="array-condition">
                    <option value="0">환불신청일순</option>
                    <option value="1">환불신청일 역순 </option>
                </select>
            </div>
                    		...
                    		<c:when test = "${ rfList.size() != 0}"> 
		                    	<c:forEach var="rf" items="${ rfList }" varStatus="no">
			                        <tr>
			                            ...
			                            <td style="display:none">${ rf.deliveryMsg }</td>
			                            <td style="display:none">${ rf.adminMemo }</td>
					                    <td>
				                            <c:choose>
				                            	<c:when test="${ empty rf.deliveryMsg }">
					                        ...
					                        <c:choose>
					                        	<c:when test="${ empty rf.adminMemo }">
