        ...
        <div class="bar-outer" id="search-area">
            <form action="">
                ...
                <div class="form-check form-check-inline">
                    <span>취소상태</span>
                    <input type="radio"> 전체
                    <input type="radio"> 반품신청
                    <input type="radio"> 반품처리중(수거전)
                    <input type="radio"> 반품처리중(환불전)
                    <input type="radio"> 반품완료
                </div>
                <br>
                <div id="search-btn">
        ...
        <div id="result-area">
            ...
            <div id="array-div">
                <select name="" id="array-condition">
                    <option value="">반품일 최신순</option>
                    <option value="">반품일 역순 </option>
                </select>
            </div>
