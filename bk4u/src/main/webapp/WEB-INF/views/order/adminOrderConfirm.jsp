        ...
        <div id="processing-area">
            <div class="processing-outer">
                <div class="processing-box selected">
                    <div class="selected img-area">
                        <img class="selected img-content" src="../resources/processing selected.png" alt="">
                    </div>
            ...
            <div class="processing-outer">
                <div class="processing-box">
                    <div class="img-area">
                        <img class="selected img-content" src="../resources/production.png" alt="">
                    </div>
            ...
            <div class="processing-outer">
                <div class="processing-box">
                    <div class="img-area">
                        <img class="selected img-content" src="../resources/box.png" alt="">
                    </div>
            ...
            <div class="processing-outer">
                <div class="processing-box">
                    <div class="img-area">
                        <img class="selected img-content" src="../resources/delivery.png" alt="">
                    </div>
            ...
            <div class="processing-outer">
                <div class="processing-box">
                    <div class="img-area">
                        <img class="selected img-content" src="../resources/complete.png" alt="">
                    </div>
