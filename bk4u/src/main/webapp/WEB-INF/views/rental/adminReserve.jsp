	...
	$(function(){
		...
		$("#handling-btn button").each(function(){
			$(this).click(function(){
				...
				location.href="adminRentalStatusHandling.re?selectedRNo=" + checkArr + "&statusValue=" + $(this).val() + "&page=reserve";
			})
		})
	})
</script>
...
<body>
	...
	<div id="outer">
        ...
        <div id="result-area">
            ...
            <div id="handling-btn">
                <button value="cancel">예약취소</button>
                <button value="rental">대여중</button>
            </div>
