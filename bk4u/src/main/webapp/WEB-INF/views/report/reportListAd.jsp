		...
		<script>
		 ...
		 <div id="paging-wrap">
            <ul class="pagination">
                ...
                <c:otherwise>
                	<li class="page-item"><a class="page-link" href="listAd.re?currentPage=${ pi.currentPage-1 }">Previous</a></li>
                </c:otherwise>
                </c:choose>
                
                <c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}"> 
                <li class="page-item"><a class="page-link" href="listAd.re?currentPage=${ p }">${ p }</a></li>
                </c:forEach>
             ...
             <c:choose>
             	...
             	<c:otherwise>
             		<li class="page-item"><a class="page-link" href="listAd.re?currentPage=${ pi.currentPage+1 }">Next</a></li>
		        </c:otherwise>
             </c:choose>            
            </ul>
