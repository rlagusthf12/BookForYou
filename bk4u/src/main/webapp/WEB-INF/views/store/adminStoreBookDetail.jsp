...
<script>
        $(function(){
        	...
        	/* 도서 상태 */
        	const $bkStatus = `${ offB.bkStatus }`
        	$("input[name='storeBkStatus']").each(function(){
        ...
        /* form submit전에 '관심사' 체크박스 하나라도 체크되게끔 검사하기 */
        function check() {
        	var checkedItrs = document.getElementsByName("itrs");
        	for(var i=0; i<checkedItrs.length; i++) {
        		if(checkedItrs[i].checked == true) {
        			return true;
        		}
        	}
...
<body>
	...
	<div id="outer">
        ...
        <div>
            <form action="storeBookUpdate.bk" method="POST" onsubmit="return check();" enctype="multipart/form-data">
                 ...
                 <div id="info-area">
                    ...
                    <div id="book-info">
                        <div class="book-info-content">
                            ...
                            <div>
                                <input type="text" style="width:350px;" name="bkTitle" value="${ book.bkTitle }" required>
                            </div>
                        </div>
                        <div class="book-info-content">
                            <div class="div-name">저자</div>
                            <div>
                                <input type="text" name="writerName" value="${ book.writerName }" required>
                            </div>
                        </div>
                        <div class="book-info-content">
                            <div class="div-name">출판사</div>
                            <div>
                                <input type="text" name="bkPublish" value="${ book.bkPublish }" required>
                            </div>
                        </div>
                        <div class="book-info-content">
                        ...
                        <div class="book-info-content">
                            ...
                            <div>
                                <input type="text" name="bkPrice" value="${ book.bkPrice }" style="width:100px;" required>
                            </div>
                        </div>
                        <div class="book-info-content">
                            <div class="div-name">위치</div>
                            <div>
                                <input type="text" name="bkLct" value="${ offB.bkLct }" style="width:100px;" required>
                            </div>
                        </div>
                    </div>   
                    <div id="status-area">
                        <div class="book-status a">
                            <input type="radio" id="bkStatusY" name="storeBkStatus" value="대여가능" required><label for="bkStatusY">대여가능</label>
                            <input type="radio" id="bkStatusN" name="storeBkStatus" value="대여중"><label for="bkStatusN">대여중</label>
                            <input type="radio" id="bkStatusR" name="storeBkStatus" value="예약중" required><label for="bkStatusR">예약중</label>
                        </div>
                    </div>
                </div>
